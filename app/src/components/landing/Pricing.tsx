...
const tiers: PricingTier[] = [
  {
    ...
    price: "$0",
    period: "/month",
    description: "Start learning with essentials included.",
    features: [
      "Up to 2 decks",
  ...
  },
  {
    ...
    price: "$3.99",
    period: "/month",
    description: "Unlock unlimited studying with AI assist.",
    features: [
      "Unlimited decks & sessions",
  ...
  },
  {
    ...
    price: "$5.99",
    period: "/month",
    description: "Everything unlimited for power learners.",
    features: [
      "Unlimited decks & sessions",
      "Unlimited public/shared decks",
