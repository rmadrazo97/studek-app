 ...
 *
 * Sent when user requests a new verification email.
 */
...
export function verificationEmailTemplate(
  ...
  const content = `
    ...
    <p style="margin: 0 0 24px 0; color: #a1a1aa; font-size: 16px; line-height: 1.6; text-align: center;">
      Hey ${displayName}, you requested a new verification link.
    </p>
    ...
    <p style="margin: 0 0 32px 0; color: #d4d4d8; font-size: 15px; line-height: 1.7;">
      Click the button below to verify your email address and unlock all features of your Studek account.
    </p>
    ...
    <div style="background-color: #27272a; border-radius: 8px; padding: 16px; margin-top: 24px;">
      <p style="margin: 0; color: #a1a1aa; font-size: 13px; line-height: 1.6;">
        ...
        If you didn't request a new verification email, you can safely ignore this message. Your account is secure.
      </p>
    </div>
  ...
  return {
    subject: 'Verify your Studek email address',
